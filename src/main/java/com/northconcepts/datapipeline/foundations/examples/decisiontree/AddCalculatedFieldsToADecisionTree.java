    ...
    public static void main(String[] args) {
        ...
        DecisionTree tree = new DecisionTree()
                ...
                .setRootNode(new DecisionTreeNode()
                        ...
                        .addNode(new DecisionTreeNode().setCondition("overAgeThreshold == true")
                                .addNode(new DecisionTreeNode().setCondition("houseOwned == true")
                                        .addOutcome("Eligible", "true")
                                        )

                                .addNode(new DecisionTreeNode()
                                        .setCondition("houseOwned == false")
                                        .addNode(new DecisionTreeNode().setCondition("Income >= 2000")
                                                .addOutcome("Eligible", "true")
                                                )
                                        .addNode(new DecisionTreeNode().setCondition("Income < 2000")
                        ...
                        .addNode(new DecisionTreeNode()
                                ...
                                .addNode(new DecisionTreeNode().setCondition("Income >= 3000")
                                        .addOutcome("Eligible", "true")
                                        )
                                .addNode(new DecisionTreeNode().setCondition("Income < 3000")
                                        .addOutcome("Eligible", "false")
