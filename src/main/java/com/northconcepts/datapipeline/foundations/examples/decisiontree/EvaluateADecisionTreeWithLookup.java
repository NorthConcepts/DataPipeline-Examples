    ...
    public static void main(String[] args) {
        ...
        DecisionTree tree = new DecisionTree()
                ...
                .setRootNode(new DecisionTreeNode()
                        ...
                        .addNode(new DecisionTreeNode().setCondition("Price == null || Price < 20")
                                .addOutcome("Shipping", "0.00")
                                .addOutcome("Currency", "lookup(0, currencyLookup, toUpperCase(${Currency Code}))")
                        )

                        .addNode(new DecisionTreeNode().setCondition("Price  < 50")
                                .addOutcome("Shipping", "5.00")
                                .addOutcome("Currency", "lookup(0, currencyLookup, toUpperCase(${Currency Code}))")
                        )

                        .addNode(new DecisionTreeNode().setCondition("Price  < 100")
