...
public class ReadAFlatFileDeclarativelyUsingXml {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        DataMappingPipeline pipeline = new DataMappingPipeline().fromXml(ReadAFlatFileDeclarativelyUsingJson.class.getResourceAsStream("ReadAFlatFileDeclaratively.xml"));
