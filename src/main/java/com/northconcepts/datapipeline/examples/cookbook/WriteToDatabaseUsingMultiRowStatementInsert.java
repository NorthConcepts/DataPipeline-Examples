...
import com.northconcepts.datapipeline.jdbc.insert.MultiRowStatementInsert;
import com.northconcepts.datapipeline.job.Job;

public class WriteToDatabaseUsingMultiRowStatementInsert {
	...
	public static void main(String[] args) {
		...
		DataWriter writer = new JdbcWriter(connection, DATABASE_TABLE, new MultiRowStatementInsert().setDebug(true))
							.setBatchSize(100); // set batch size
